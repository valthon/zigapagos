> **Attribution notice:** This is the original README of [Zine](https://zine-ssg.io)
> by Loris Cro (kristoff-it), preserved verbatim from the fork point
> (zine v0.11.2, commit 496e42d). Zigapagos is a permanent fork; see the
> repository README for what changed. Zine's MIT license is retained in /LICENSE.
