...
grep -q '"module": "ESNext"' "$NEXT_TARGET/tsconfig.json" || fail "Next.js target TypeScript config omitted its ES module mode"
grep -q '"target": "ESNext"' "$NEXT_TARGET/tsconfig.json" || fail "Next.js target TypeScript config omitted its language target"
grep -q '"allowImportingTsExtensions": true' "$NEXT_TARGET/tsconfig.json" || fail "Next.js target TypeScript config rejected generated TypeScript imports"
grep -q '"noEmit": true' "$NEXT_TARGET/tsconfig.json" || fail "Next.js target TypeScript config may emit files during validation"
